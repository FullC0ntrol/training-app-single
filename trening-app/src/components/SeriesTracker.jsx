...
const SeriesTracker = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (!formData.weight || !formData.reps) return; // Zapobiega dodaniu pustych wartości
        setSets([...sets, { ...formData, id: Date.now() }]);
    ...
    return (
        <div className="max-w-full mx-auto bg-gray-800 rounded-xl shadow-lg overflow-visible p-6">
