...
const BenchPress = () => {
    ...
    const sections = {
        start: (
            <div>
                ...
                <ol className="list-decimal list-inside space-y-2">
                    ...
                    <li>
                        Chwyć sztangę nachwytem (palce wskazują przód, kciuki
                        skierowane do środka) na taką szerokość, aby w połowie
                        wykonywania ruchu kąt między ramieniem a przedramieniem
                        wynosił 90 stopni.
                    </li>
                    <li>
                        Łopatki ściągnięte, barki opuszczone i mocno dociśnięte
                        do ławeczki.
                    </li>
                    <li>
                        Zachowaj naturalne ustawienie kręgosłupa – odcinek
                        lędźwiowy lekko uniesiony, pośladki na ławeczce.
                    </li>
                </ol>
            </div>
        ),
        movement: (
            <div>
                ...
                <ol className="list-decimal list-inside space-y-2">
                    <li>
                        Utrzymując prawidłową pozycję wyjściową, wykonaj wdech i
                        powolnym ruchem opuść sztangę do środkowej części klatki
                        piersiowej, uginając ramiona w łokciach.
                    </li>
                    <li>
                        Po przytrzymaniu sztangi w okolicach klatki przez ułamek
                        sekundy zacznij unosić sztangę z powrotem do pozycji
                        wyjściowej, wykonując wydech powietrza. Skup się, aby
                        wyciskanie następowało z mięśnia piersiowego.
                    </li>
                    <li>
                        W momencie wyprostowania ramion ze sztangą (unikaj
                        przeprostu w łokciach) mocno dopnij mięsień piersiowy,
                        po czym ponownie zacznij opuszczać sztangę.
                    </li>
        ...
        tips: (
            <div>
                ...
                <ol className="list-decimal list-inside space-y-2">
                    ...
                    <li>
                        Dbając o staw łokciowy, nie doprowadzaj do pełnego
                        wyprostu ramienia pod ciężarem.
                    </li>
                    ...
                    <li>
                        Tempo opuszczania sztangi powinno być dwa razy
                        wolniejsze niż jej wyciskanie.
                    </li>
                </ol>
            </div>
        ),
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white">
            ...
            <div className="pb-16">
                {" "}
                {/* Dodaj padding na dole aby stopka nie zasłaniała treści */}
                {/* Twój obecny kod */}
                <WorkoutFooter
                    currentExercise={2}
                    totalExercises={5}
